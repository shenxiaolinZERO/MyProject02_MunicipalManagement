<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateclass.aspx.cs" Inherits="ysmzadmin_article_updateclass" %>
    ...
    <div class="pagebody">
      ...
      <div class="pagebody1">
        ...
        <div class="houtai_right">
         <div class="houtai_right_title">芙蓉特色修改类别</div>
         <div class="houtai_right_pic">
         <table style="width:100%; height:35px; border:1px solid #565656">
         <tr>
         <td style="width: 70px; padding-left:10px; vertical-align:middle; height: 34px;"><asp:Label ID="Label1" runat="server" Text="Label">修改类别：</asp:Label></td>
         <td style="width:290px; height: 34px;"><asp:TextBox ID="TextBox1" runat="server" Width="280px"></asp:TextBox></td>
         <td align="center" style="height: 34px"><asp:Button ID="e_add" runat="server" Text="添 加" Height="28px" /></td>
         <td align="center" style="height: 34px"><asp:Button ID="e_edit" runat="server" Text="修 改" Height="28px" OnClick="e_edit_Click" /></td>
         <td align="center" style="height: 34px"><asp:Button ID="e_back" runat="server" Text="返 回" OnClick="e_back_Click" Height="28px" /></td>
         </tr>          
         </table>           
         </div>
         ...
         <div><asp:TextBox ID="TextBox2" runat="server" Visible="False"></asp:TextBox>
        </div>            
      </div>
    </div>
    </form>
