<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addguanggao.aspx.cs" Inherits="ysmzadmin_guanggao_addguanggao" %>
    ...
    <<div class="pagebody">
      ...
      <div class="pagebody1">
        ...
        <div class="houtai_right">
         <div class="houtai_right_title">芙蓉特色添加广告</div>
         <div class="houtai_right_pic">
         <table style="width:100%; height:35px; border:1px solid #565656">
         <tr>
         <td style="width: 70px; padding-left:10px; vertical-align:middle; height: 34px;"><asp:Label ID="Label1" runat="server" Text="Label">添加广告：</asp:Label></td>
         ...
         <td align="center" style="height: 34px"><asp:Button ID="btnadd" runat="server" Text="添 加"  Height="28px" OnClick="btnadd_Click" /></td>
         <td align="center" style="height: 34px"><asp:Button ID="btnupdate" runat="server" Text="修 改" Height="28px" /></td>
         <td align="center" style="height: 34px"><asp:Button ID="backet" runat="server" Text="返 回"  Height="28px" OnClick="backet_Click" /></td>
         </tr>          
         </table>           
         </div>
         <div class="houtai_right_pic1"><asp:GridView ID="guang_GridView" runat="server" AllowPaging="True" AutoGenerateColumns="False" BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" PageSize="9" Width="626px">
             <Columns>
