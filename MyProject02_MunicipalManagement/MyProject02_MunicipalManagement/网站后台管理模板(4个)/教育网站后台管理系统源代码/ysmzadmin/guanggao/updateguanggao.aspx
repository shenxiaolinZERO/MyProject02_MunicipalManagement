<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateguanggao.aspx.cs" Inherits="ysmzadmin_guanggao_updateguanggao" %>
    ...
    <div class="pagebody">
      ...
      <div class="pagebody1">
        <div class="houtai_left"><uc1:userleft ID="Userleft1" runat="server" /></div>
         ...
         <div class="houtai_right_title">芙蓉特色修改广告</div>
          <div class="houtai_right_pic">
         <table style="width:100%; height:35px; border:1px solid #565656">
         <tr>
         <td style="width: 70px; padding-left:10px; vertical-align:middle"><asp:Label ID="Label1" runat="server" Text="Label">修改广告：</asp:Label></td>
         ...
         <td align="center" style="height: 34px"><asp:Button ID="p_back" runat="server" Text="返 回" Height="28px" OnClick="p_back_Click" /></td>
         </tr>          
         </table>           
         </div>
